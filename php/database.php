...
include("global.inc.php");
	...
	/*Ampenan
	$server =  $glob['dbhost'];//'192.168.1.140';
	$username = $glob['dbusername'] ;// 'root';
	$password = $glob['dbpassword'];//'monita2010';
	$database = $glob['dbdatabase'];//'monita3';
	*/
	
	//daunbiru.com/monita3
	$server =  $glob['dbhost'];//'192.168.1.140';
	$username = $glob['dbusername'] ;// 'root';
	$password = $glob['dbpassword'];//'monita2010';
	$database = $glob['dbdatabase'];//'monita3';
...
db_connect($server, $username, $password, $database) or die('Unable to connect to database server!');
...
function db_connect($server = 'localhost', $username = 'monita', $password = 'diesel', $database = 'monita3', $link = 'db_link') {
